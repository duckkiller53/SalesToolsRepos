//
//  ProdLookupTable.swift
//  SalesTools
//
//  Created by William Volm on 2/24/16.
//  Copyright © 2016 Dave LaPorte. All rights reserved.
//

import UIKit

class ProdLookupTable: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        {
            if let destinationVC = segue.destinationViewController as? ProdLookupDetail
            {
